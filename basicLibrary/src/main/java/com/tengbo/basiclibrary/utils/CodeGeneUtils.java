...
public class CodeGeneUtils {
    ...
    private static CodeGeneUtils mCodeGeneUtils;
    ...
    public static CodeGeneUtils getInstance() {
        if (mCodeGeneUtils == null) {
            mCodeGeneUtils = new CodeGeneUtils();
        }
        return mCodeGeneUtils;
    }
    ...
    private int randomColor() {
        ...
        return Color.parseColor("#5483e3");
    }
