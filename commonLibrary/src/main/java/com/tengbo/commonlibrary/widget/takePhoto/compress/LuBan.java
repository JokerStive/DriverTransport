...
public class LuBan {
    ...
    public LuBan loadWithFile(File file) {
        mFile = file;
        return this;
    }

    public LuBan loadWithFiles(List<File> filePath) {
        mFileList = filePath;
        return this;
    }

    public LuBan loadWithPath(String path) {
        mFile = new File(path);
        return this;
    }

    public LuBan loadWithPaths(List<String> paths) {
    ...
    public LuBan setSaveFileName(String filename) {
    ...
    public Observable<List<File>> asFileList() {
        if (gear == FIRST_GEAR)
    ...
    public File thirdCompress(@NonNull File file) {
        ...
        String thumb = mSaveDir.getAbsolutePath() + File.separator +
                (TextUtils.isEmpty(fileName) ? System.currentTimeMillis() : fileName) + "compress.jpg";
